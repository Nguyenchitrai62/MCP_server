...
# client = OpenAI(api_key="FAKEAPI", base_url="http://10.0.8.23:1235/v1")
client = OpenAI(api_key="FAKEAPI", base_url="http://54.213.248.28:8233/v1")
model= "openai/gpt-oss-20b"

# client = OpenAI(
#     api_key="AIzaSyB0IJ0S4syOZpJI8MIc_OwdjxgVV8vgsjQ",
...
if __name__ == "__main__":
    sse_server_map = {
        "python_executor_mcp": "https://api.nguyenchitrai.id.vn/sse",
    }
    ...
    async def main():
        ...
        input_messages = [
            ...
            {"role": "user", "content": "tính tổng 112 và 123"},
        ]
